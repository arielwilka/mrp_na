...
import ProductionWorkOrder from '../modules/production/views/ProductionWorkOrder.vue'; // <--- IMPORT BARU
    ...
    children: [
      ...
      // --- [BARU] PRODUCTION SYSTEM (ENGINEERING) ---
      {
        ...
        children: [
            ...
            { 
                path: 'work-orders', // URL: /production/work-orders <--- ROUTE BARU
                name: 'ProdWorkOrder', 
                component: ProductionWorkOrder, 
                meta: { module: 'production_ppic', requiresPermission: 'read' } 
            }
        ]
      },
