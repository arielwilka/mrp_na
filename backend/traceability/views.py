...
class SerialRuleViewSet(viewsets.ModelViewSet):
    ...
    def test_validate(self, request, pk=None):
        """
        Endpoint test untuk memastikan Rule berjalan benar sebelum dipakai produksi.
        Payload: { "scan_input": "BAT12345" }
        """
...
class PartMasterViewSet(viewsets.ModelViewSet):
    ...
    # Filter 'is_qc_required' ditambahkan agar frontend bisa ambil part yg wajib QC saja
    filterset_fields = ['validation_rule', 'is_qc_required']
