...
class PartMaster(models.Model):
    ...
    # --- [UPDATE PENTING] RELASI PRODUK (SIMPLE BOM) ---
    # Field ini menentukan part ini BOLEH dipakai di mobil apa saja.
    # Digunakan untuk filtering di Route Manager.
    compatible_product_types = models.ManyToManyField(
        ProductType, 
        related_name='compatible_parts',
        blank=True,
        help_text="Pilih Tipe Produk yang menggunakan part ini."
    )
    # ---------------------------------------------------
